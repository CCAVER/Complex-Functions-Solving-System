...
def changetext(a=12,b='',a0=44,uid=1):
 path='D:\\学习系列\\毕业论文-定档\\'+str(uid)+'\\'
 b='  return '+b
 count=0
 #print(path)
 ...
 b0=str('        plt.title(r\'$'+re.sub(r'mathopen{}\\|mathclose{}\\', "", str(fs.f))+'$\')')
 #userFunc是fucs里的函数表达式  删除在控制台执行时产生的  mathopen{} mathclose{}
 count1=0
